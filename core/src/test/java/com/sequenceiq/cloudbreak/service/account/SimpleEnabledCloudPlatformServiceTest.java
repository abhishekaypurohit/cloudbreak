...
public class SimpleEnabledCloudPlatformServiceTest {
    ...
    @InjectMocks
    private final EnabledCloudPlatformService underTest = new EnabledCloudPlatformService();
    ...
    public void testEnabledPlatformsWhenEnabledPlatformsIsEmpty() {
        ReflectionTestUtils.setField(underTest, EnabledCloudPlatformService.class, "enabledPlatforms", "", null);
    ...
    public void testEnabledPlatformsWhenEnabledPlatformsIsNotEmpty() {
        ReflectionTestUtils.setField(underTest, EnabledCloudPlatformService.class, "enabledPlatforms", "AWS,PL1,PL2", null);
        Set<String> actual = underTest.enabledPlatforms();
